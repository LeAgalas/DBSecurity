...
2. **Объектные роли:**
   ...
   - **Вложенная роль:**
     - `admin`: Роль, включающая в себя `product_manager`, `inventory_manager` и другие необходимые роли (еще и доступ к таблице sales).
...
## Результаты:
В результате данной лабораторной работы было произведено ознакомление со схемами и ролями в PostgreSQL. Для тестовой базы данных магазина кросовок были созданы схема и несколько ролей, которым были выданы необходимые привилегии для работы с определенными таблицами.
